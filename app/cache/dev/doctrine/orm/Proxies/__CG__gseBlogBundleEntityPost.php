...
namespace Proxies\__CG__\gse\BlogBundle\Entity;

/**
 * DO NOT EDIT THIS FILE - IT WAS CREATED BY DOCTRINE'S PROXY GENERATOR
 */
class Post extends \gse\BlogBundle\Entity\Post implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return array('__isInitialized__', 'id', 'titulo', 'cuerpo', 'urlImg', 'tag_ids');
        }
    ...
    public function setTagIds(\gse\BlogBundle\Entity\Tag $tagIds = NULL)
    {
        ...
        $this->__initializer__ && $this->__initializer__->__invoke($this, 'setTagIds', array($tagIds));

        return parent::setTagIds($tagIds);
    }
    ...
    public function getTagIds()
    {
        ...
        $this->__initializer__ && $this->__initializer__->__invoke($this, 'getTagIds', array());
