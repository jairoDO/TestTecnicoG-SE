...
class TagController extends Controller
{
    ...
    public function indexAction()
    {
        ...
        $entities = $em->getRepository('gseBlogBundle:Tag')->findAll();
     ...
     * @Method("POST")
     * @Template("gseBlogBundle:Tag:new.html.twig")
     */
    ...
    */
    ...
    public function showAction($id)
    {
        ...
        $entity = $em->getRepository('gseBlogBundle:Tag')->find($id);
    ...
    */
     ...
     * @Method("PUT")
     * @Template("gseBlogBundle:Tag:edit.html.twig")
     */
